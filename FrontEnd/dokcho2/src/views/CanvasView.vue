<template>
  <div id="main">
    <button @click="restart">초기화</button>
...
export default {
  ...
  methods: {
    ...
    map() {
      ...
      this.fallingSpeed = 0
      console.log(this.fallingAcceleration, this.fallingSpeed)
    ...
    restart() {
      const oldDiv = document.getElementById('webgl-container')
      oldDiv.remove()
      const newDiv = document.createElement('div')
      newDiv.id = 'webgl-container'
